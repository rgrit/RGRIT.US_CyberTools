...
### 📁 `possible_rootkit_investigation.py` Directory
| 📄 **Script Name** | **Description** | **Link** |
|--------------------|----------------|----------|
| `Incident_Response/possible_rootkit_investigation.py` | Linux incident response script. Investigates a PID for rootkit/malware signs via system calls, network checks, & rootkit scanners. Outputs f | [Link](https://github.com/rgrit/RGRIT.US_CyberTools/blob/main/Incident_Response/possible_rootkit_investigation.py) |
